...
public class TicketController {
    ...
    public String checkUser() {
        ...
        String result = ticketService.checkUser();
        return result;
    }
    ...
    public String getStationInfo(@RequestBody String payload) {
        ...
        String url = UrlConstant.OTN_URL + "czxx/queryByTrainNo";
    ...
    private String changeMessages(String result) {
        if (result.startsWith("{")) {
            ...
            if (!ObjectUtils.isEmpty(jsonObject.get("messages")) && jsonObject.getString("messages").startsWith("[\"您还有未处理的订单")) {
