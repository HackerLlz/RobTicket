(function (window) {
   ...
   touclick["getTouclickHtml"] = function (randCodeName) {
    ...
    var passcodeNewUrl = 'https://kyfw.12306.cn/otn/passcodeNew/getPassCodeNew';
	touclick["common_fun_refreshImg"] = function(module,place,randCodeId) {
		...
		if(randCodeImg){
            ...
            randCodeImg.src= passcodeNewUrl + "?module=" + module + "&rand=" + place + '&' + Math.random();
		}
...
$(document).ready(function () {
	...
	(function(){
		...
		for (var i = 0; i<targetelement.length;i++){
			...
			var randCodeName = TouLocal.getRandCodeName(targetelement[i]);
			var html =  "<li><span class=\"label\">验证码：</span><div class=\"yzm\" style=\"padding: 0px\"><input type=\"text\" name=\"randCode\" data-targetdiv=\""+targetdiv[i]+ "\" tabindex=\"3\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"code\" id=\"img-check\"><img style=\"width: 100%;height: 100%\"   onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\"  src=\"" + passcodeNewUrl + "?module=login&rand=sjrand&\" title=\"单击刷新验证码\"onclick=\"refreshImg('login','sjrand')\" id=\"img_rand_code\"></span><span class=\"i-re\" onclick=\"refreshImg('login','sjrand')\" title=\"单击刷新验证码\"></span></div><div class=\"\"><span class=\"tip i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;\"></span></div></li><li id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;margin-left: 70px ;margin-top: 5px;padding-left:20px;\"class=\"error error_msg_li error_msg"+targetdiv[i]+"\"></li>";
		    
			if (typeof code_type !== "undefined" && code_type !== null) {
				if("" == targetelement[i]){
					if(code_type == "regist"){
					module='regist',rand='sjrand';//regist&rand=sjrand
					html="<li><div class=\"label\"><span class=\"required\">*</span>验证码：</div><div class=\"yzm\" style=\"padding: 0px\"><input type=\"text\" name=\"randCode\" data-targetdiv=\""+targetdiv[i]+"\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"img\" id=\"img-check\"><img style=\"width: 100%;height: 100%\"  onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\"  src=\"" + passcodeNewUrl + "?module=regist&rand=sjrand&\" title=\"单击刷新验证码\"onclick=\"refreshImg('regist','sjrand')\" id=\"img_rand_code\"></span><span class=\"i-re\" onclick=\"refreshImg('regist','sjrand')\" title=\"单击刷新验证码\"></span></div><div class=\"tips\"><span class=\"icon i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;\"></span></div></li><label id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;\"class=\"error error_msg"+targetdiv[i]+"\"></label>";
					
					}else if(code_type == "findpassword"){
					module='findpassword',rand='sjrand';//findpassword&rand=sjrand
					html="<li><div class=\"label\"><span class=\"required\">*</span>验证码：</div><div class=\"yzm\" style=\"padding: 0px\"><input type=\"text\" name=\"randCode\" data-targetdiv=\""+targetdiv[i]+ "\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"img\" id=\"img-check\"><img onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\"  style=\"width: 100%;height: 100%\" src=\"" + passcodeNewUrl + "?module=findpassword&rand=sjrand&\" title=\"单击刷新验证码\"onclick=\"refreshImg('findpassword','sjrand')\" id=\"img_rand_code\"></span><span class=\"i-re\" onclick=\"refreshImg('findpassword','sjrand')\" title=\"单击刷新验证码\"></span></div><div class=\"tips\"><span class=\"icon i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;\"></span></div></li><label id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;padding-top:3px;margin-top:10px;\"class=\"error error_msg"+targetdiv[i]+"\"></label>";
					
					}else if(code_type == "passenger"){
					module='passenger',rand='randp';//passenger&rand=randp
					html="<li id=\"code_rand\"><span class=\"label\"  th:text=\"#{randCode}\">验证码：</span><input id=\""+randCodeName+"\" tabindex=\"3\"  name=\"randCode\" data-targetdiv=\""+targetdiv[i]+ "\" type=\"text\" maxlength=\"4\" class=\"inptxt w100\" />	<span class=\"code\" id=\"img-check\"><img style=\"width: 120px;height:40px;margin-top:-20px;position: relative;top: 13px;\" onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\"  src=\"" + passcodeNewUrl + "?module=passenger&rand=randp&\"  onclick=\"refreshImg('passenger','randp')\""+"title=\"单击刷新验证码\" id=\"img_rand_code\"/></span>	<span class=\"i-re\" onclick=\"refreshImg('passenger','randp')\" title=\"单击刷新验证码\"></span>	<span class=\"tip i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display:none;margin-left:10px;margin-bottom:-4px;\"></span> </li><li class=\"error error_msg"+targetdiv[i]+"\" id=\"error_msg"+targetdiv[i]+"\" style=\"display: none; margin-top:-2px;margin-left:10px;padding-top:8px\"></li><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/>";
					
					}
				}else{
					if(code_type == "regist"){
					module='regist',rand='sjrand';
					html="<li><div class=\"label\"><span class=\"required\">*</span>验证码：</div><div class=\"yzm\" style=\"padding: 0px\"><input type=\"text\" name=\"randCode\" data-targetdiv=\""+targetdiv[i]+ "\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"img\" id=\"img-check\"><img style=\"width: 100%;height: 100%\" src=\"" + passcodeNewUrl + "?module=regist&rand=sjrand&\" onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\"  title=\"单击刷新验证码\"onclick=\"refreshImg('regist','sjrand')\" id=\"img_rand_code\"></span><span class=\"i-re\" onclick=\"refreshImg('regist','sjrand')\" title=\"单击刷新验证码\"></span></div><div class=\"tips\"><span class=\"icon i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;\"></span></div></li><label id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;\"class=\"error\"></label>";
					
					}else if(code_type == "findpassword"){
					module='findpassword',rand='sjrand';
					html="<li><div class=\"label\"><span class=\"required\">*</span>验证码：</div><div class=\"yzm\" style=\"padding: 0px\"><input type=\"text\" name=\"randCode\" data-targetdiv=\""+targetdiv[i]+"\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"img\" id=\"img-check_"+targetelement[i]+"\"><img style=\"width: 100%;height: 100%\" src=\"" + passcodeNewUrl + "?module=findpassword&rand=sjrand&\" onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\" title=\"单击刷新验证码\"onclick=\"refreshImg('findpassword','sjrand','"+targetelement[i]+"')\" id=\"img_rand_code_"+targetelement[i]+"\"></span><span class=\"i-re\" onclick=\"refreshImg('findpassword','sjrand','"+targetelement[i]+"')\" title=\"单击刷新验证码\"></span></div><div class=\"tips\"><span class=\"icon i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;\"></span></div></li><label id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;\"class=\"error error_msg"+targetdiv[i]+"\"></label>";
					
					}else if(code_type == "passenger"){ 
					module='passenger',rand='randp';
					html="<li id=\"code_rand\"><span class=\"label\"  th:text=\"#{randCode}\">验证码：</span><input id=\""+randCodeName+"\" data-targetdiv=\""+targetdiv[i]+ "\" tabindex=\"3\"  name=\"randCode\" type=\"text\" maxlength=\"4\" class=\"inptxt w100\" />	<span class=\"code\" id=\"img-check\"><img style=\"width: 120px;height: 40\" onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\" src=\"" + passcodeNewUrl + "?module=passenger&rand=randp&\"  onclick=\"refreshImg('passenger','randp','"+targetelement[i]+"')\""+"title=\"单击刷新验证码\" id=\"img_rand_code_"+targetelement[i]+"\"/></span>	<span class=\"i-re\" onclick=\"refreshImg('passenger','randp','"+targetelement[i]+"')\" title=\"单击刷新验证码\"></span>	<span class=\"tip i-ok i-ok"+targetdiv[i]+"\" id=\"i-ok"+targetdiv[i]+"\" style=\"display:none\"></span> </li><li id=\"error_msg"+targetdiv[i]+"\" class=\"error error_msg"+targetdiv[i]+"\" style=\"display: none; margin-top:-2px;margin-left:10px;padding-top:8px\"></li><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/>";
					
					}else if(code_type == "login"){
					module='login',rand='sjrand';//login&rand=sjrand
					html =  "<li><div class=\"yzm\" style=\"padding: 0px\"><span class=\"label\">验证码：</span><input type=\"text\" name=\"randCode2\" data-targetdiv=\""+targetdiv[i]+ "\" tabindex=\"3\" id=\""+randCodeName+"\" maxlength=\"4\" class=\"inptxt w100\"><input type=\"hidden\" id=\"randCode_validate\" name=\"randCode_validate\"/><span class=\"code\" id=\"img-check_"+targetelement[i]+"\"><img style=\"width: 100%;height: 100%\" src=\"" + passcodeNewUrl + "?module=login&rand=sjrand&\" title=\"单击刷新验证码\"onclick=\"refreshImg('login','sjrand','"+targetelement[i]+"')\" onload=\"__captcha_reload_fun('"+module+"','"+rand+"')\" id=\"img_rand_code_"+targetelement[i]+"\"></span><span class=\"i-re\" onclick=\"refreshImg('login','sjrand','"+targetelement[i]+"')\" title=\"单击刷新验证码\"></span></div><div class=\"\"><span class=\"tip i-ok i-ok"+targetdiv[i]+"\"  id=\"i-ok"+targetdiv[i]+"\" style=\"display: none;margin-top:5px;\"></span></div></li><li id=\"error_msg"+targetdiv[i]+"\"  style=\"display: none;margin-left: 285px ;margin-top: -19px;\"class=\"error error_msg"+targetdiv[i]+"\"></li>";
...
//		}
	...
	if(TouLocal.checkZInTargetType()){
        ...
        gs.src = "/js/common/captcha_js.js";
        ...
        TouLocal.insertCssFile("/css/common/captcha_css.css");
    }else{
		if($('#submitOrder_id')[0]){
    ...
    TouLocal.insertCssFile("/css/common/local.css");
